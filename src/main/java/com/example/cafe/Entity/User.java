...
@NamedQuery(name = "User.getAllUser", query = "SELECT new com.example.cafe.wrapper.UserWrapper(u.id, u.name, u.userName, u.contactNumber,u.role, u.status) FROM User u ")
